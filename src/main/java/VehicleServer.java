...
public class VehicleServer {
    ...
    void start() throws IOException {
        int port = 50053;
        // Build and start the server on the specified port, adding the implemented
        // service.
        ...
        // Add a shutdown hook to ensure clean shutdown, such as when the JVM is
        // shutting down.
    ...
    /**
     * Blocks until the server is completely shut down, meaning it will not accept
     * any more incoming calls.
     *
    ...
    /**
     * Implementation of the VehicleService from the gRPC definition. This service
     * streams event notifications.
     */
    static class VehicleServiceImpl extends VehicleServiceGrpc.VehicleServiceImplBase {
         ...
         *
         * @param req              The request containing information like the vehicle
         *                         ID.
         * @param responseObserver The observer used to send event notifications back to
         *                         the client.
         */
        @Override
     ...
     * @throws InterruptedException If the server is interrupted during its
     *                              execution.
     */
