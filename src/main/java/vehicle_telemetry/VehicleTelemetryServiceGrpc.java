...
public final class VehicleTelemetryServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "vehicle_telemetry.VehicleTelemetryService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<vehicle_telemetry.VehicleTelemetry.TelemetryData,
      vehicle_telemetry.VehicleTelemetry.TelemetryResponse> getStreamTelemetryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamTelemetry",
      requestType = vehicle_telemetry.VehicleTelemetry.TelemetryData.class,
      responseType = vehicle_telemetry.VehicleTelemetry.TelemetryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<vehicle_telemetry.VehicleTelemetry.TelemetryData,
      vehicle_telemetry.VehicleTelemetry.TelemetryResponse> getStreamTelemetryMethod() {
    io.grpc.MethodDescriptor<vehicle_telemetry.VehicleTelemetry.TelemetryData, vehicle_telemetry.VehicleTelemetry.TelemetryResponse> getStreamTelemetryMethod;
      ...
      synchronized (VehicleTelemetryServiceGrpc.class) {
        if ((getStreamTelemetryMethod = VehicleTelemetryServiceGrpc.getStreamTelemetryMethod) == null) {
          VehicleTelemetryServiceGrpc.getStreamTelemetryMethod = getStreamTelemetryMethod =
              io.grpc.MethodDescriptor.<vehicle_telemetry.VehicleTelemetry.TelemetryData, vehicle_telemetry.VehicleTelemetry.TelemetryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamTelemetry"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  vehicle_telemetry.VehicleTelemetry.TelemetryData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  vehicle_telemetry.VehicleTelemetry.TelemetryResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<vehicle_telemetry.VehicleTelemetry.TelemetryData> streamTelemetry(
        io.grpc.stub.StreamObserver<vehicle_telemetry.VehicleTelemetry.TelemetryResponse> responseObserver) {
  ...
  public static final class VehicleTelemetryServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<vehicle_telemetry.VehicleTelemetry.TelemetryData> streamTelemetry(
        io.grpc.stub.StreamObserver<vehicle_telemetry.VehicleTelemetry.TelemetryResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              vehicle_telemetry.VehicleTelemetry.TelemetryData,
              vehicle_telemetry.VehicleTelemetry.TelemetryResponse>(
  ...
  private static abstract class VehicleTelemetryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return vehicle_telemetry.VehicleTelemetry.getDescriptor();
    }
